    ...
    <div className="flex flex-col min-h-screen bg-slate-50 text-slate-950 font-[family-name:var(--font-geist-sans)]">
      <header className="flex h-16 items-center px-4 sm:px-8 border-b bg-white shadow-sm sticky top-0 z-50">
        ...
        <nav className="ml-auto flex items-center gap-4">
          ...
          <Link href="/auth">
            <Button className="font-semibold bg-red-600 hover:bg-red-700">Try Demo</Button>
          </Link>
        </nav>
      </header>

      <main className="flex-1 flex flex-col items-center justify-center text-center px-4 py-20 sm:py-32">
        <div className="inline-flex items-center rounded-full border border-stone-200 bg-stone-50 px-3 py-1 text-sm text-red-800 mb-8 font-medium">
        ...
        <h1 className="text-4xl sm:text-6xl font-extrabold tracking-tight max-w-4xl text-slate-900 mb-6 leading-tight">
          Detect faster. <span className="text-red-600">Respond smarter.</span> Save lives.
        </h1>
        ...
        <div className="flex flex-col sm:flex-row gap-4">
          <Link href="/auth">
            <Button size="lg" className="w-full sm:w-auto h-14 px-8 text-lg font-semibold shadow-lg bg-red-600 hover:bg-red-700 gap-2">
        ...
        <div className="grid sm:grid-cols-3 gap-8 mt-24 max-w-5xl w-full text-left">
          ...
          <div className="bg-white p-6 rounded-2xl shadow-sm border border-slate-100">
            <div className="h-12 w-12 bg-stone-100 text-red-600 rounded-lg flex items-center justify-center mb-4">
              <ShieldCheck className="h-6 w-6" />
            </div>
